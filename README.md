...
# Summary
Supply Chain can be complex based on how corporations carry out their business and relationship to entities. The concepts that I have laid out in this are generally applicable to any retail chains or fast food chains such as McDonald's, Burger King, Arbys, Subway etc. All though I gained significant amount of knowledge there is plenty to learn, in my humble opinion one life time is not enough. 
